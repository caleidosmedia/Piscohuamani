<?php echo form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=transcribe'.AMP.'method=templates', array('id' => 'filterMenu')); ?>
    <fieldset>
...
<?php echo form_open('C=addons_modules'.AMP.'M=show_module_cp'.AMP.'module=transcribe'.AMP.'method=templates'); ?>
